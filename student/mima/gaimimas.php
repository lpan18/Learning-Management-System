...
if(s.newpass.value==s.old.value)
{
alert("输入的新密码与旧密码相同！");
s.new1.focus();
return false;
...
if(s.new1.value!=s.newpass.value)
{
alert("两次密码输入不一致！");
s.new1.focus();
return false;
...
<form id="formgaimi" name="formgaimi" method="post" action="gaimimas2.php" onsubmit="return check()">
<div align="center"><b><font size='6'>密码修改</font></b><br><br><br><br></div>
