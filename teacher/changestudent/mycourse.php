...
$namet = $_SESSION['TEACH'];
	...
	$sql = "select course.cno,course.cname,count(*)from course,teacher,sc where sc.sccno=course.cno and course.ctno=teacher.tno and teacher.tname='$namet'  group by cno";
