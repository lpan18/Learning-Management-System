...
<input id="submit" value="查看" name="submit" type="submit" style="height:40px;width:80px;" style="font-size:20;">
</p>
...
<?php
			...
			?>
<table border='1' space="0" align='center' width=900  Cellpadding=10>
